...
struct User : Hashable, Codable, Identifiable {
    ...
    static func TestUser() -> User {
        return User(login: "TestLogin", id: 0, node_id: "TestNodeID", avatar_url: "EmptyUser", gravatar_id: "TestGravatarID", url: "TestUrl", html_url: "TestHtmlUrl", followers_url: "TestFollowersUrl", following_url: "TestFollowingUrl", gists_url: "TestGistsUrl", starred_url: "TestStarredUrl", subscriptions_url: "TestSubscriptions", organizations_url: "TestOrganizationsUrl", repos_url: "TestReposUrl", events_url: "TestEventsUrl", received_events_url: "TestReceivedEventsUrl", type: "TestType", site_admin: true, name: "Test Name", company: nil, blog: "http://test.blog.com", location: "Test location", email: nil, hireable: nil, bio: "test", public_repos: nil, public_gists: nil, followers: nil, following: nil, created_at: nil, updated_at: nil)
    }
}
